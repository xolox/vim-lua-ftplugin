...
function! xolox#lua#misc#complete#keywords(arglead, cmdline, cursorpos)
  ...
  "
  "     :command -nargs=* -complete=customlist,xolox#lua#misc#complete#keywords MyCmd call s:MyCmd(<f-args>)
  let words = {}
